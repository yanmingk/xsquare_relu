...
for m in range(1,range_m):
    ...
    for j in range(num_models):
        ...
        train_with_LBFGS(model, criterion, X_train, y_train, 1, 0, train_losses, norm_g, record_g = 0, verbose = False)
...
plt.savefig(f'C:\\Users\\Yanming\\codes\\square\\bfgs-optimal-perturb1e-2.png')
...
#         plt.savefig(f'C:\\Users\\Yanming\\codes\\square\\losses\\LBFGS-m{m}model{j}')
